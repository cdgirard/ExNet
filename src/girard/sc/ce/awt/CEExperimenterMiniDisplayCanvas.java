...
public class CEExperimenterMiniDisplayCanvas extends Canvas implements MouseListener,MouseMotionListener
    {
    ...
    CENetwork m_network;
    CEExperimenterDisplayCanvas m_area;
    boolean m_mousePressed = false;

    public CEExperimenterMiniDisplayCanvas(CENetwork n,CEExperimenterDisplayCanvas edc)
        {
        m_network = n;
        m_area = edc;
    ...
    public CEExperimenterMiniDisplayCanvas(CENetwork n, CEExperimenterDisplayCanvas edc, Point tl, Point br)
        {
        m_network = n;
        m_topLeft = tl;
        m_bottomRight = br;
