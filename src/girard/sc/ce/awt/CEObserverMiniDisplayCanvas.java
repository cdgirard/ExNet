...
/**
 * This is the mini version of the main display area for the observer
...
public class CEObserverMiniDisplayCanvas extends Canvas implements MouseListener,MouseMotionListener
    {
    ...
    CENetwork m_network;
    CEObserverDisplayCanvas m_area;
    boolean m_mousePressed = false;

    public CEObserverMiniDisplayCanvas(CENetwork n,CEObserverDisplayCanvas edc)
        {
        m_network = n;
        m_area = edc;
    ...
    public CEObserverMiniDisplayCanvas(CENetwork n, CEObserverDisplayCanvas edc, Point tl, Point br)
        {
        m_network = n;
        m_topLeft = tl;
        m_bottomRight = br;
   ...
   // If the top-bottom edges of the viewing area are off the screen move the center point.
    ...
    public void paint(Graphics g)
        ...
        while (enm.hasMoreElements())
            {
            CEEdge cce = (CEEdge)enm.nextElement();
