...
/* This class is a mini display area of the main display area.
...
public class CCObserverMiniDisplayCanvas extends Canvas implements MouseListener,MouseMotionListener
    {
    Point m_topLeft = new Point(0,0);
    Point m_bottomRight = new Point(NetworkBuilder.WIDTH,NetworkBuilder.HEIGHT);
    double[] m_level = { 0.65, 0.73, 0.81, 0.90, 1 };
    CCNetwork m_network;
    CCObserverDisplayCanvas m_area;
    boolean m_mousePressed = false;

    public CCObserverMiniDisplayCanvas(CCNetwork n,CCObserverDisplayCanvas edc)
        {
        m_network = n;
        m_area = edc;
    ...
    public CCObserverMiniDisplayCanvas(CCNetwork n, CCObserverDisplayCanvas edc, Point tl, Point br)
        {
        m_network = n;
        m_topLeft = tl;
        m_bottomRight = br;
