...
public class CCObserverDisplayCanvas extends Canvas
    {
    Point m_topLeft = new Point(0,0);
    Point m_bottomRight = new Point (NetworkBuilder.WIDTH,NetworkBuilder.HEIGHT);
    CCNetwork m_network;

    public CCObserverDisplayCanvas(CCNetwork net)
        {
        m_network = net;
        }
    public CCObserverDisplayCanvas(CCNetwork net,Point tl, Point br)
        {
        m_network = net;
        m_topLeft = tl;
        m_bottomRight = br;
