...
public class ExptActionTypesListReq extends WLQuery
    {

    public ExptActionTypesListReq(WLServerConnection wlsc, WLMessage wlm)
        {
    ...
    public ResultSet runQuery() 
        ...
        synchronized (m_DBA)
            ...
            try 
                ...
                ResultSet rs = stmt.executeQuery("SELECT * FROM Actions_Type_T");
