...
public class BEObserverDisplayCanvas extends Canvas
    {
    Point m_topLeft = new Point(0,0);
    Point m_bottomRight = new Point (NetworkBuilder.WIDTH,NetworkBuilder.HEIGHT);
    BENetwork m_network;

    public BEObserverDisplayCanvas(BENetwork net)
        {
        m_network = net;
        }
    public BEObserverDisplayCanvas(BENetwork net,Point tl, Point br)
        {
        m_network = net;
        m_topLeft = tl;
        m_bottomRight = br;
    ...
    public void paint(Graphics g)
        ...
        while (enm.hasMoreElements())
            ...
            e.updateObserverImage(g2,dim,m_topLeft,m_bottomRight);
            }
        ...
        while (enm.hasMoreElements())
            ...
            n.updateObserverImage(g2,dim,m_topLeft,m_bottomRight);
            }
