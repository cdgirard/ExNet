...
public class BEExperimenterMiniDisplayCanvas extends Canvas implements MouseListener,MouseMotionListener
    {
    ...
    BENetwork m_network;
    BEExperimenterDisplayCanvas m_area;
    boolean m_mousePressed = false;

    public BEExperimenterMiniDisplayCanvas(BENetwork n,BEExperimenterDisplayCanvas edc)
        {
        m_network = n;
        m_area = edc;
    ...
    public BEExperimenterMiniDisplayCanvas(BENetwork n, BEExperimenterDisplayCanvas edc, Point tl, Point br)
        {
        m_network = n;
        m_topLeft = tl;
        m_bottomRight = br;
