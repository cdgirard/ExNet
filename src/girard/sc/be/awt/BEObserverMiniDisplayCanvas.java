...
public class BEObserverMiniDisplayCanvas extends Canvas implements MouseListener,MouseMotionListener
    {
    ...
    BENetwork m_network;
    BEObserverDisplayCanvas m_area;
    boolean m_mousePressed = false;

    public BEObserverMiniDisplayCanvas(BENetwork n,BEObserverDisplayCanvas edc)
        {
        m_network = n;
        m_area = edc;
    ...
    public BEObserverMiniDisplayCanvas(BENetwork n, BEObserverDisplayCanvas edc, Point tl, Point br)
        {
        m_network = n;
        m_topLeft = tl;
        m_bottomRight = br;
