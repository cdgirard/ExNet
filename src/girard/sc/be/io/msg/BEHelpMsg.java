...
import girard.sc.be.awt.BEHelpWindow;
...
public class BEHelpMsg extends ExptMessage 
    { 
    public BEHelpMsg (Object args[])
        {
        super(args);
        }
...
// System.err.println("ESR: Help Message");
        ...
        if (ec != null)
            ...
            synchronized(ec)
                ...
                if (index == ExptComptroller.EXPERIMENTER)
                    ...
                    ec.addServerMessage(new BEHelpMsg(out_args));
                    return null;
                    }
                }
            }
            ...
            err_args[1] = new String("BEHelpMsg");
    ...
    public void getExperimenterResponse(ExperimenterWindow ew)
        ...
        BEHelpWindow hw = new BEHelpWindow(naew,index.intValue());
